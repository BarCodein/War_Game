...
export default {
  ...
  'vg.mission.attackBefore': 'Complete before the time limit ({time} left)',
  'vg.mission.annihilate': 'Eliminate marked enemies ({alive}/{total} left)',
  'vg.mission.holdBase': 'Hold base {city}',
  'vg.mission.eliminateEnemy': 'Eliminate all enemies',
  'editor.new': 'New',
  'editor.save': 'Save',
  'editor.load': 'Load',
